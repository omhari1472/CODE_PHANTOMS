...
const FrameComponent2: FunctionComponent<FrameComponent2Type> = ({
  ...
  return (
    <div
      className={`w-[274px] rounded-xl bg-white box-border flex flex-col items-center justify-start pt-[22px] pb-[23px] pr-[11px] pl-3.5 gap-[16px] ml-[-42.1px] text-left text-base text-black font-inter border-[1px] border-solid border-lightgray-200 mq450:pt-[22px] mq450:pb-5 mq450:box-border ${className}`}
    ...
    >
      ...
      <div className="self-stretch flex flex-col items-center justify-start pt-0 px-0 pb-0 gap-[20px]">
        <div className="self-stretch flex flex-col items-start justify-center py-0 px-[3px] gap-[10px]">
          <h2 className="m-0 relative text-inherit capitalize font-semibold font-inherit inline-block min-w-[36px]">
            {jeepRenegade}
          </h2>
